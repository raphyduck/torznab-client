...
describe Torznab::Client::Caps::Instance do
  ...
  describe '.search_modes' do
    ...
    context 'when invalid' do
      ...
      it { expect { subject }.to raise_error Torznab::Client::Errors::CapsError, 'Search_modes must be a SearchModes instance' }
    end
  end
  ...
  describe '.categories' do
    ...
    context 'when it is not an array' do
      let(:categories) { '8040' }
      it { expect { subject }.to raise_error Torznab::Client::Errors::CapsError, 'Categories must be an array' }
    end
    ...
    context 'when it is not an array composed only with Category objects' do
      ...
      it { expect { subject }.to raise_error Torznab::Client::Errors::CapsError, 'Categories must be composed only of instances of Category' }
    end
  end
end
